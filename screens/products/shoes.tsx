...
const ShoesProductsSC: React.FC = () => {
        ...
        loadMore: async () => {
            try {
                ...
                const res = await axios(
                    `http://localhost:8080/api/vnb/v1/product/get-products?page=${page}&limit=10&type=shoes&sort=${sort}`
                );
    ...
    return (
        <SafeAreaView className='flex-1 bg-[#e6eff4]'>
            <HeaderCmp title='Shoes' />
            {searchContainer && (
...
export default ShoesProductsSC;
