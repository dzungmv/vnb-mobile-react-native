...
const ShirtProductsSC: React.FC = () => {
        ...
        loadMore: async () => {
            try {
                ...
                const res = await axios(
                    `http://localhost:8080/api/vnb/v1/product/get-products?page=${page}&limit=10&type=shirt&sort=${sort}`
                );
    ...
    return (
        <SafeAreaView className='flex-1 bg-[#c9b6d7]'>
            <HeaderCmp title='Shirt' />
            {searchContainer && (
...
export default ShirtProductsSC;
