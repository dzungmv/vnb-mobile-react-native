...
const SkirtProductsSC: React.FC = () => {
        ...
        loadMore: async () => {
            try {
                ...
                const res = await axios(
                    `http://localhost:8080/api/vnb/v1/product/get-products?page=${page}&limit=10&type=skirt&sort=${sort}`
                );
    ...
    return (
        <SafeAreaView className='flex-1 bg-[#ffb4c1]'>
            <HeaderCmp title='Skirt' />
            {searchContainer && (
...
export default SkirtProductsSC;
